          ...
          <div class='box'>
            ...
            <div class='box-body'>
              ...
              <div class='alert alert-success alert-dismissible'>
                ...
                Pastikan informasi akun sesuai dengan identitas yang sudah terdaftar, Untuk Mengubah informasi Profile anda klik <a href='".base_url()."administrator/edit_manajemenuser/".$this->session->username."'>disini</a>.
              </div>
            </div>
          </div>
        </div>";
