									...
									<?php 
										...
										foreach ($album->result_array() as $row) {
											...
											<div class="post--item post--layout-1">
												<div class="post--img">
													<a href="albums" class="thumb"><img src="<?php echo base_url()."template/" . template() . "/timthumb.php?src=" . base_url() . "asset/img_album/$row[gbr_album]"?>&amp;w=450&amp;h=300" alt="<?php echo $row['jdl_album']; ?>"></a>
													<div class="post--info">
														<div class="title">
