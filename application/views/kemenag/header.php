...
?>
	...
	<div style="padding:0px;">
			...
			?>
			<span class="hidden">Sistem Informasi Administrasi Prodi PTIK</span></a></h1>
	</div>
	...
	<div class="header--navbar style--1 navbar bd--color-1 bg--color-1" data-trigger="sticky">
		<div class="container">
			...
			<div id="headerNav" class="navbar-collapse collapse float--left">
				...
				<li class='dropdown'><a href='http://localhost/portal/main'>Beranda</a></li>
				<li class='dropdown'><a href='http://localhost/portal/berita'>Berita</a></li>
				<li class='dropdown'><a href='http://localhost/portal/albums'>Galeri Foto</a></li></ul>
				</ul>
			</div>
		</div>
	</div>
